...
var commandContracts = map[string]CommandContract{
	...
	"dcr": {
		...
		Status:           StatusImplemented,
		Model:            "DCROutput",
		OperatorQuestion: "Which Data Collection Rules can reshape Azure Monitor collection, routing, destinations, associations, or transformations from the management plane?",
		TopLevelFields: []string{
			"dcrs",
			"findings",
			"issues",
	...
	"diagnostic-settings": {
		...
		Section:          "resource",
		Status:           StatusImplemented,
		Model:            "DiagnosticSettingsOutput",
		OperatorQuestion: "Which visible resources can reshape Azure telemetry export through diagnostic settings, selected categories, and sink routing?",
		TopLevelFields: []string{
			"sources",
			"findings",
			"issues",
	...
	"monitoring-sinks": {
		Name:             "monitoring-sinks",
		Section:          "resource",
		Status:           StatusImplemented,
		Model:            "MonitoringSinksOutput",
		OperatorQuestion: "Which visible or declared monitoring destinations can DCRs and diagnostic settings route Azure telemetry toward?",
		TopLevelFields: []string{
			"sinks",
			"findings",
			"issues",
	...
	"relay": {
		...
		Status:           StatusImplemented,
		Model:            "RelayOutput",
		OperatorQuestion: "Which Azure Relay namespaces and Hybrid Connections expose the strongest cloud rendezvous and private-path masking posture?",
		TopLevelFields: []string{
			"findings",
			"issues",
			"metadata",
	...
	"appinsights": {
		...
		Section:          "resource",
		Status:           StatusImplemented,
		Model:            "AppInsightsOutput",
		OperatorQuestion: "Which Application Insights components and instrumented app settings expose visible sampling, filtering, or telemetry-level posture clues?",
		TopLevelFields: []string{
			"components",
			"targets",
			"findings",
	...
	"evasion": {
		...
		Status:           StatusImplemented,
		Model:            "EvasionOutput",
		OperatorQuestion: "Which Azure-native evasion surface most quietly changes defender truth from current management-plane evidence?",
		TopLevelFields: []string{
			"metadata",
			"grouped_command_name",
			"selected_surface",
	...
	"resourcehijacking": {
		Name:             "resourcehijacking",
		Section:          "orchestration",
		Status:           StatusImplemented,
		Model:            "ResourceHijackingOutput",
		OperatorQuestion: "Which existing Azure resource can current access most directly commandeer, redirect, replace, or repurpose?",
		TopLevelFields: []string{
			"metadata",
			"grouped_command_name",
			"selected_surface",
	...
	"pathmasking": {
		...
		Section:          "orchestration",
		Status:           StatusImplemented,
		Model:            "PathMaskingOutput",
		OperatorQuestion: "Which Azure-native middle layer most obscures the real path between caller, cloud surface, and backend?",
		TopLevelFields: []string{
			"metadata",
			"grouped_command_name",
			"selected_surface",
